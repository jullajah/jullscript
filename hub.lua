...
-- CONTOH TOMBOL (ganti URL dengan script kamu sendiri)
addTechButton("Tech 1", 50, function()
    loadstring(game:HttpGet("https://your.script.url/tech1.lua"))()
end)

addTechButton("Tech 2", 80, function()
    loadstring(game:HttpGet("https://your.script.url/tech2.lua"))()
end)

addTechButton("Tech 3", 110, function()
    loadstring(game:HttpGet("https://your.script.url/tech3.lua"))()
end)
